...
2. **Open SVG File**:
  - After running the QueenGambit Chess Engine and generating the `chess_board.svg` file in your project directory, locate the file in the Visual Studio Code Explorer.
...
5. **Interact with SVG**:
  - You can interact with the SVG file in the browser as it updates in real-time based on the current state of the chessboard generated by QueenGambit.
...
By following these steps, you can use the Live Server extension in Visual Studio Code to dynamically view and interact with SVG files such as `chess_board.svg` generated by QueenGambit during gameplay.
